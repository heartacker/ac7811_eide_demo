...
void EXTI1_IRQHandler(void)
{
    ...
    if (g_gpioCallbackArray[1])
    {
        g_gpioCallbackArray[1](tmpGPIONum);
    }
...
void EXTI2_IRQHandler(void)
{
    ...
    if (g_gpioCallbackArray[2])
    {
        g_gpioCallbackArray[2](tmpGPIONum);
    }
...
void EXTI3_IRQHandler(void)
{
    ...
    if (g_gpioCallbackArray[3])
    {
        g_gpioCallbackArray[3](tmpGPIONum);
    }
...
void EXTI4_IRQHandler(void)
{
    ...
    if (g_gpioCallbackArray[4])
    {
        g_gpioCallbackArray[4](tmpGPIONum);
    }
...
void EXTI5_9_IRQHandler(void)
{
    ...
    for (i = 0x20; i < 0x400; i = i << 1)
    {
        ...
        {
            tmpGPIONum = GPIO_GetPendingExtIntGPIONum((uint32_t)(log(i) / log(2)));

            if (g_gpioCallbackArray[5])
            {
                g_gpioCallbackArray[5](tmpGPIONum);
            }
...
void EXTI10_15_IRQHandler(void)
{
    ...
    for (i = 0x400; i < 0x10000; i = i << 1)
    {
        if (tmpGPIOPendingIRQMask & i)
        {
            ...
            if (g_gpioCallbackArray[6])
            {
                g_gpioCallbackArray[6](tmpGPIONum);
            }
...
/**
 * GPIO_SetEventCallback
 *
 * @param[in] gpioNum:GPIO number,value can be GPIO_GroupNum type data,defined in ax78xx_gpio.h
 * @param[in] callback:GPIO_EventCallBack function,which will be called in EXTIx_IRQHandler()
...
* GPIO_SetFuncGroup
*
* @param[in]  GPIOx: GPIO type structure pointer,x can be A.B...E
* @param[in]  pinMask: GPIO pin mask value indicate which gpios need to be modifyed
* @param[in]  functionx: GPIO group function,refer to reference manual
* @return     0: success
*
...
* @param[in]    GPIOx: GPIO type structure pointer,x can be A.B...E
* @param[in]  pinMask: GPIO pin mask value indicate which gpios need to be modifyed
* @param[in]  pinMode: GPIO group pin mode, value can be 1:output  0:input
* @return     0: success
*
...
int32_t GPIO_SetPinFallingEdgeEnable(uint32_t gpioNum, FunctionalState fallingEdgeEnable)
{
    ...
    tmpGPIOxPinNum = gpioNum % GPIO_ONE_GROUP_NUM;           // Calculate GPIO Group's Internal Pin Number(0~15)
    tmpFallEdgeValue = (uint32_t)fallingEdgeEnable;
...
int32_t GPIO_SetPinRisingEdgeEnable(uint32_t gpioNum, FunctionalState risingEdgeEnable)
{
    ...
    tmpGPIOxPinNum = gpioNum % GPIO_ONE_GROUP_NUM;           // Calculate GPIO Group's Internal Pin Number(0~15)
    tmpRisingEdgeValue = (uint32_t)risingEdgeEnable;
...
int32_t GPIO_ClearPendingExtInt(uint32_t gpioNum)
{
    ...
    GPIOINT->GPIO_IFPR.Byte = 1 << tmpGPIOxPinNum;
...
int32_t GPIO_SetPinExtIntMaskEnable(uint32_t gpioNum, FunctionalState intMaskEnable)
{
    ...
    {
    case 0:
        GPIOINT->GPIO_IMR.Bit.IM0 = (uint32_t)intMaskEnable;
        break;
    case 1:
        GPIOINT->GPIO_IMR.Bit.IM1 = (uint32_t)intMaskEnable;
        break;
    case 2:
        GPIOINT->GPIO_IMR.Bit.IM2 = (uint32_t)intMaskEnable;
        break;
    case 3:
        GPIOINT->GPIO_IMR.Bit.IM3 = (uint32_t)intMaskEnable;
        break;
    case 4:
        GPIOINT->GPIO_IMR.Bit.IM4 = (uint32_t)intMaskEnable;
        break;
    case 5:
        GPIOINT->GPIO_IMR.Bit.IM5 = (uint32_t)intMaskEnable;
        break;
    case 6:
        GPIOINT->GPIO_IMR.Bit.IM6 = (uint32_t)intMaskEnable;
        break;
    case 7:
        GPIOINT->GPIO_IMR.Bit.IM7 = (uint32_t)intMaskEnable;
        break;
    case 8:
        GPIOINT->GPIO_IMR.Bit.IM8 = (uint32_t)intMaskEnable;
        break;
    case 9:
        GPIOINT->GPIO_IMR.Bit.IM9 = (uint32_t)intMaskEnable;
        break;
    case 10:
        GPIOINT->GPIO_IMR.Bit.IM10 = (uint32_t)intMaskEnable;
        break;
    case 11:
        GPIOINT->GPIO_IMR.Bit.IM11 = (uint32_t)intMaskEnable;
        break;
    case 12:
        GPIOINT->GPIO_IMR.Bit.IM12 = (uint32_t)intMaskEnable;
        break;
    case 13:
        GPIOINT->GPIO_IMR.Bit.IM13 = (uint32_t)intMaskEnable;
        break;
    case 14:
        GPIOINT->GPIO_IMR.Bit.IM14 = (uint32_t)intMaskEnable;
        break;
    case 15:
        GPIOINT->GPIO_IMR.Bit.IM15 = (uint32_t)intMaskEnable;
        break;
...
*
* @param[in]  gpioNum: GPIO number,value can be GPIO_GroupNum type data,defined in ax78xx_gpio.h
* @param[in]  E4E2Value: GPIO E4E2 value which can be 0: 4mA; 1: 8mA; 2: 12mA; 3: 16mA
